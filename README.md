...
```bash
curl "http://localhost:8080/explorar?tipo=people&pagina=1&limite=10"
```
...
Se quiser usar o backend local, ajuste em `frontend/index.html`:
...
### 4.1. Endpoint principal: `/explorar`
